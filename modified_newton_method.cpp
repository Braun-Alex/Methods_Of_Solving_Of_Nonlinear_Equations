...
std::string Modified_Newton_Method::Name() const
{
return "modified newton method";
}
void Modified_Newton_Method::Execute(double accuracy, std::pair<double, double> section,
...
derivative_value=Derivative_Function(current_argument);
...
{
++i;
current_difference=current_value/derivative_value;
current_argument-=current_difference;
current_value=function.function(current_argument);
Modified_Newton_Method_Print(i, current_argument, current_difference, current_value);
}
}